...
const { id, nama, ...informasiLain } = dataPengguna;
...
|-------|----------------|----------------|
| **Fungsi** | Menyebarkan elemen | Mengumpulkan elemen |
| **Posisi** | Di sisi kanan assignment | Di sisi kiri assignment |
| **Penggunaan** | Memanggil function, membuat array/object | Parameter function, destructuring |
| **Hasil** | Elemen individual | Array atau object |
